    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark menuTop">
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
              ...
              <form class="form-inline my-2 my-lg-0">
                <input class="form-control mr-sm-2" type="search" placeholder="Buscar Gif" aria-label="Search" name="buscar">
      ...
      <div class="container align-items-center" id = "mainColum">      
                        ...
                        else
                        {
                            ...
                            $empezar_desde = ($pagina-1) * $por_pagina;
                            $querylimit = "SELECT * FROM tblgif LIMIT $empezar_desde,$por_pagina";
              ...
              ESPACIO PARA PUBLICIDAD
                        ...
                        <div id="paginacion">
                            <?php
                                ...
                                $query = "SELECT * FROM tblgif";
                                $resultado = mysqli_query($Conexion,$query);
                                $num_filas = mysqli_num_rows($resultado);
                                $total_paginas = ceil($num_filas / $por_pagina);

                                echo "<a href='Gif.php?pagina=1' id= 'primera'>".'Primera'."</a>";
                                for($i =1;$i<=$total_paginas;$i++)
                                {
                                    echo "<a id ='paginas' href='Gif.php?pagina=".$i."'>".$i."</a>";
                                }
                                echo "<a id = 'ultima' href='Gif.php?pagina=$total_paginas'>". ' Ultima'."</a>";
